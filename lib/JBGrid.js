        ...
        return (
            <div className={"jb-grid-wrapper " + (this.props.className ?? "")} ref={(dom) => vm.JBGridComponentDom = dom} style={this.props.style}>
                <section key={'jb-grid-header'} className="jb-grid-header">
                    <section className={"main-section " + (vm.config.states.headerSection == HeaderSections.main ? "" : "hidden")}>
                    ...
                    <section className={"search-section " + (vm.config.states.headerSection == HeaderSections.search ? "" : "hidden")}>

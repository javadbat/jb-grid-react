        ...
        <section key={'jb-grid-footer'} className="jb-grid-footer">
            ...
            <section className="page-section">
                ...
                <section className="items-information-section">
                    <span>{vm.toPersianNumber(vm.config.data.metaData.startItemIndex)}</span>
                    <span>-</span>
                    <span> {vm.toPersianNumber(vm.config.data.metaData.endItemIndex)} </span>
                    <span> &nbsp;از</span>
                    <span title="تعداد کل ایتم های موجود">&nbsp; {vm.toPersianNumber(vm.config.data.metaData.totalItemsCount)} &nbsp;</span>

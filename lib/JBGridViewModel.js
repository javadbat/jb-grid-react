...
class JBGridViewModel {
    ...
    CreateRequestBody() {
        ...
        var requestBody = this.dataBridge.createRequestBody(this.config.page, this.filter.value, sortColumn, this.config.data);
        return requestBody;
    }
    ...
    debounce(func, delay) {
        ...
        var debounseInstance = function () {
            return new Promise((resolve, reject) => {
                ...
                inDebounce = setTimeout(() => func.apply(self, args).then((args) => {
                    resolve(args);
    ...
    openSearchHeaderSection() {
        ...
        this.config.states.headerSection = HeaderSections.search;
    }
    openMainHeaderSection() {
        this.config.states.headerSection = HeaderSections.main;
    }
    showErrorPanel() {
